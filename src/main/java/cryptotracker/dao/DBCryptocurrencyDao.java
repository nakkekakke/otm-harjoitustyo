 ...
 * 
 */
public class DBCryptocurrencyDao implements CryptocurrencyDao {
    
    private final Database database;
    private final DBPortfolioDao portfolioDao;

    public DBCryptocurrencyDao(Database database, DBPortfolioDao portfoliodao) {
